...
@SourceType(value = "ApacheHiveARP", label = "ApacheHive",uiConfig = "apachehive-layout.json")
public class ApacheHiveConf extends AbstractArpConf<ApacheHiveConf> {
  private static final String ARP_FILENAME = "arp/implementation/apachehive-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.apachehive.ApacheHiveDriver";
